...
render(){
    ...
    <Dialog  aria-labelledby="Login" open={this.state.showLogin} >
      <DialogTitle id="Login" style={{color:'#fff',backgroundColor:"#aaaaee"}}>Login for Skolarships</DialogTitle>
    ...
    Register
      ...
      <DialogTitle id="Login" style={{color:'#fff',backgroundColor:"#aaaaee"}}>Register for Skolarships</DialogTitle>
      <form style={{display:'flex',flexDirection:"column", padding:"10px",width:"400px"}}  >
