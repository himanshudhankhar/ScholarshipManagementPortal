...
constructor(props){
    ...
    this.closeApplications=this.closeApplications.bind(this);
}
...
showApplications(){
    this.setState({displayApplications:true});
}


render(){
    return(
        <Card style={{display:"flex",flexDirection:"row",padding:10,margin:"auto",maxWidth:1000,alignItems:"center",justifyContent:"center",marginBottom:10}}>
        ...
        <h1>Swami Vivekanad UG Research Scholarship</h1>
            <h6>Swami Vivekanad Foundation</h6>

            <p>Swami Vivekanad Foundation provides scholarship for research in the field of science , engineering and medical sciences to the meritorious students Rs4000/pm</p>
            </div>
...
<b>2019-8-12</b> 
             ...
             <Button variant="contained" color="primary" style={{margin:"auto",marginTop:5,marginBottom:5}} onClick={this.showApplications} >View Applications</Button>
